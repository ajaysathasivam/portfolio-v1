  ...
  const projects = [
    {
      ...
      description: "A collaborative AI coding workspace with integrated debugging tools, real-time code optimization suggestion, and natural language model executors.",
      image: "/devflow.jpg",
      tags: ["Next.js", "TypeScript", "Tailwind CSS", "OpenAI API", "Socket.io"],
      liveUrl: "https://example.com",
      githubUrl: "https://github.com",
    },
    {
      title: "Aether UI Catalog",
      description: "A gorgeous, modular design system catalog featuring highly interactive React components with custom Tailwind v4 configurations and fluid motion transitions.",
      image: "/aether.jpg",
      tags: ["React 19", "Tailwind CSS v4", "TypeScript", "Framer Motion"],
      liveUrl: "https://example.com",
      githubUrl: "https://github.com",
    },
    {
      title: "Helix Analytics Dashboard",
      description: "A real-time Web3 finance and cryptocurrency transaction tracker displaying rich animations, SVG charting, and multi-currency exchange charts.",
      image: "/helix.jpg",
      tags: ["Next.js", "Chart.js", "Tailwind CSS", "Web3.js", "WebSockets"],
      liveUrl: "https://example.com",
      githubUrl: "https://github.com",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col items-start mb-20">
          ...
          <p className="text-text-secondary mt-4 max-w-xl font-light text-base md:text-lg">
            A handpicked selection of production-grade websites and design systems I have developed.
          </p>
        </div>
              ...
              <div className="p-6 md:p-8 flex flex-col flex-1 gap-4">
                ...
                <div className="flex items-center gap-4 pt-4 border-t border-white/5 mt-2">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-1.5 text-xs font-semibold text-accent-cyan hover:text-accent-cyan/80 transition-colors duration-200 ml-auto"
                  >
                    <span>Live Demo</span>
